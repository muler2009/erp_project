...
import { Input, Button } from '../../../common/Reusable'
...
const LoginInputs = () => {
  ...
  return (
    <div className='flex-1 bg-[#013243] bg-opacity-5 flex justify-center items-center py-5'>
          <div className='w-1/3 shadow-lg bg-[#fff] rounded-lg pt-10 py-5 my-5'>
              ...
              <form className='flex flex-col gap-6 pb-10' onSubmit={(event) => event.preventDefault()}>
              {/* Username Field */}
                <div className='my-10 flex flex-col gap-5 px-10'>
                ...
                <div className='flex flex-col px-10'>
                  ...
                  <Button 
                    label="Login" 
                    className='bnt-sm font-Poppins rounded-sm px-5 hover:bg-[#00bdff] hover:text-white hover:ring-2 hover:ring-white hover:rounded-sm' 
          ...
          {/* <div className='px-20 mx-10 bg-blue-100 py-5 border-l-[5px] border-blue-600'>
            <p className=' flex justify-center font-Poppins leading-6 text-center text-sm '>
              This project control management system is designed to control various aspect of the construction project and equipped with user managememnt, tender management, Bidder management and other tools 
            </p>
          </div> */}
      </div>
  )
